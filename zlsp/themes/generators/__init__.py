...
class BaseGenerator(ABC):
    ...
    NOTE: Prism.js CSS generation also uses this base, but ONLY for colors.
    Prism.js pattern definitions (JS) are generated separately by:
        zlsp/generators/generate_prism_zolo.py (SSOT-based pattern extraction)
    """
