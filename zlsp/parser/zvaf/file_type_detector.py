...
class FileTypeDetector:
    ...
    def has_modifiers(self) -> bool:
        ...
        Only zEnv and zUI files support dispatcher modifiers.
        zSpark temporarily disabled - will be rebuilt from scratch.
        """
        return self.file_type in (FileType.ZENV, FileType.ZUI)

    def needs_zvaf(self) -> bool:
        """
