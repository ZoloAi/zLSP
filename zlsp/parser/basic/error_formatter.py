...
class ErrorFormatter:
    ...
    def format_duplicate_key_error(
        ...
        msg += "  2. Move the duplicate under a different parent\n"
        msg += "  3. Remove the duplicate if it's unintentional\n"
    ...
    def format_file_not_found_error(filepath: str) -> str:
        ...
        msg += "  4. The file extension is .zolo\n"
    ...
    def format_unsupported_extension_error(extension: str, supported: List[str]) -> str:
        ...
        msg += "  2. Or convert the file to a supported format\n"
